...
public class OperatorPractice {
	...
	public void practice2() {
		...
		String g = gender == 'M' || gender =='m' ? "남학생" : 
					(gender == 'F' || gender =='f' ? "여학생" : "오류");

		System.out.print("성적(소수점 아래 둘째자리까지) : ");
		float score = sc.nextFloat();
		
		System.out.println(
				grade + "학년 " + classes + "반 " + num + "번 " + 
				name + " " + g + "의 성적은 " + score + "이다."
				);
	}
	...
	public void practice6() {
		...
		boolean tf = num3 <= num1 || num2 <= num3;
	...
	public void practice7() {
		...
		boolean tf = num1 == num2 && num2 == num3;
		System.out.println(tf);
	}
	...
	public void practice9() {
	    ...
	    for (int j = 0; j < salaries.size(); j++) {
	        ...
	        System.out.println((char)('A' + j) + "사원 연봉/연봉+a : "
	                + salaries.get(j) + "/" + finalSalary);
	        System.out.println(result);
	    }
	}
